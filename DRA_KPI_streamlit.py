...
##Preview web title
st.title('VDRA KPI Monitoring')
st.markdown("""
This app shows the various KPI of the **VDRA** node and compare it on day to day basis.
* **Python libraries:** pandas, streamlit, bokeh
* **Data source:** Private Raw CSV File
""")

##Read csv file
df=pd.read_csv('https://raw.githubusercontent.com/ekng93/streamlit_v1.0/main/sample_data.csv', index_col=0)
